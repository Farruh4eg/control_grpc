...
const file_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x10proto/auth.proto\x12\fcontrol_grpc\"F\n" +
	"\fLoginRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"M\n" +
	"\rLoginResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\"\n" +
	"\ferrorMessage\x18\x02 \x01(\tR\ferrorMessage2O\n" +
	"\vAuthService\x12@\n" +
	"\x05Login\x12\x1a.control_grpc.LoginRequest\x1a\x1b.control_grpc.LoginResponseB\x14Z\x12control_grpc/protob\x06proto3"
